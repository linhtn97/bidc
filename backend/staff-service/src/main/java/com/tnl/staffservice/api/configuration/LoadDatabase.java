...
class LoadDatabase {
    ...
    CommandLineRunner initDatabaseStaff(StaffRepository repository) {
        ...
        return args -> {
            log.info("Preloading " + repository.save(new Staff("ST001","Linh","Tran",new Date(1997-1900,12-1,15),"1","1","1",new Date(2022-1900,01-1,01),1)));
            log.info("Preloading " + repository.save(new Staff("ST002","Quoc","Tran",new Date(1997-1900,04-1,15),"1","1","1",new Date(2022-1900,01-1,01),1)));
            log.info("Preloading " + repository.save(new Staff("ST003","Phuong","Nguyen",new Date(1997-1900,04-1,15),"1","1","1",new Date(2022-1900,01-1,01),1)));
            log.info("Preloading " + repository.save(new Staff("ST004","Trinh","Le",new Date(1997-1900,04-1,15),"1","1","1",new Date(2022-1900,01-1,01),1)));
        };
    }
